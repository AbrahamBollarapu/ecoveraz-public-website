...
export default function DoctrinePage() {
  return (
    <>
      ...
      <Section>
        <Grid>
          <div className="md:col-span-8">
            ...
            <h1 className="mt-4 text-3xl font-semibold text-text-100">
              Operating Doctrine
            </h1>
            ...
            {/* Mobile demotion of boundary language */}
            <p className="mt-3 text-xs text-text-400 md:text-sm md:text-text-300 leading-relaxed">
              Evidence ≠ outcomes. EcoVeraZ does not certify, approve, score, or
              determine compliance. Conclusions remain with external reviewers
              (audit, risk, regulators).
            </p>
      ...
      <Section
        title="Scope"
        subtitle="What EcoVeraZ does (and does not do) in regulated contexts."
      >
        <Grid>
          <div className="md:col-span-12 grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader
                ...
                right={<StatusBadge tone="good" mono>IN SCOPE</StatusBadge>}
              />
              {/* Hide dense bullets on mobile */}
            ...
            <Card>
              <CardHeader
                ...
                right={<StatusBadge tone="bad" mono>OUT OF SCOPE</StatusBadge>}
              />
              <div className="mt-2 space-y-3 hidden md:block">
                ...
                <Bullet title="No internal disclosure" body="Algorithms, schemas, and proprietary logic are not exposed." />
              </div>
            </Card>
          </div>
        </Grid>
      ...
      <Section
        title="Definitions"
        subtitle="Terms used consistently across pages and demos."
      >
        <Grid>
          <div className="md:col-span-12 grid gap-6 md:grid-cols-2">
            <Card>
              ...
              <div className="text-sm text-text-300 leading-relaxed">
                Evidence is measurement + context + time window + governed
                transformations, represented as traceable artifacts. Evidence is
                not a conclusion.
              </div>
            </Card>
            ...
            <Card>
              ...
              <div className="text-sm text-text-300 leading-relaxed">
                Review-ready means artifacts can be inspected with continuity,
                integrity, lineage, and disclosure boundaries. It does not mean
                compliant.
              </div>
            </Card>
          </div>
