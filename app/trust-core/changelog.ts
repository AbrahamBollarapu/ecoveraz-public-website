...
export type TrustCoreChange = {
  ...
  pages: string[]; // e.g. ["/doctrine", "/ladder", "/rri"]
...
export const TRUST_CORE_CHANGELOG: TrustCoreChange[] = [
  {
    date: "2025-12-23",
    version: "1.0",
    pages: ["/trust-core", "/doctrine", "/ladder", "/rri"],
    changes: [
      "Published Trust Core v1.0 as the canonical public bundle (Doctrine, Ladder, RRI Specification).",
    ...
    rationale: "Establish a stable, regulator-safe foundation that prevents silent drift and constrains downstream claims.",
  },
];
