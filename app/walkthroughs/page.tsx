        ...
        <Grid>
          <div className="md:col-span-8">
            <div className="flex items-center gap-2">
              <StatusBadge tone="neutral" mono>WALKTHROUGHS</StatusBadge>
              <StatusBadge tone="neutral" mono>REVIEW FLOW</StatusBadge>
            </div>
            ...
            <p className="mt-3 text-sm text-text-300 leading-relaxed">
              EcoVeraZ provides evidence artifacts and posture signals. Reviewers apply standards externally
              and determine conclusions.
            </p>

            <div className="mt-6 flex flex-wrap gap-2">
              <LinkButton href="/resources" variant="secondary">Back to Resources</LinkButton>
              <LinkButton href="/evidence-artifacts" variant="primary">Evidence Artifacts</LinkButton>
            </div>
          </div>
        </Grid>
      </Section>
      ...
      <Section title="Audit-style workflow" subtitle="A flow that matches regulated review behavior.">
        <Grid>
          <div className="md:col-span-12 grid gap-6 md:grid-cols-3">
            <Card>
              <CardHeader title="1) Check posture" subtitle="Is evidence inspectable?" right={<StatusBadge tone="neutral" mono>RRI</StatusBadge>} />
            ...
            <Card>
              <CardHeader title="2) Open artifacts" subtitle="Inspect what is packaged." right={<StatusBadge tone="neutral" mono>PACK</StatusBadge>} />
              <div className="space-y-3">
            ...
            <Card>
              <CardHeader title="3) Conclude externally" subtitle="Apply the rulebook outside EcoVeraZ." right={<StatusBadge tone="warn" mono>EXTERNAL</StatusBadge>} />
              <div className="space-y-3">
